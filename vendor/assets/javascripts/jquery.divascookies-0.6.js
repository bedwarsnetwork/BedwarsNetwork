...
;(function($) {
    ...
    $.DivasCookiesCore = function(options) {
		...
		// create banner text
		$bannerText = $("<p class='divascookies-banner-text'>" + settings.bannerText + "</p>");
		...
		if(settings.acceptButtonSrc !== "") {
			...
			$acceptButtonContent = $("<p class='waves-effect waves-light btn green'>" + settings.acceptButtonText + "</p>");	
		}
